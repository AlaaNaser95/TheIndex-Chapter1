                  ...
                  <div className="card">
                    <div className="image">
                      <img
                        ...
                        // src="//literature.britishcouncil.org/assets/Uploads/writers/_resampled/CroppedImage680680-Margaret-Atwood-c-Jean-Malek-web.jpg"
                        alt="George R.R. Martin"
                      />
                    </div>
                    <div className="card-body">
                      <h5 className="card-title">
                        <span>{`${authors[3].first_name} ${
                          authors[3].last_name
                        } `}</span>
                      </h5>
                      <small className="card-text">{`${
                        authors[3].books.length
                      } books`}</small>
                    </div>
                  </div>
                </div>
